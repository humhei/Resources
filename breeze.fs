...
module Breeze =
    let [<Import("config","breeze/breeze")>] config: Config.IExports = jsNative
    let [<Import("core","breeze/breeze")>] core: Core.IExports = jsNative
    ...
    type [<AllowNullLiteral>] IExports =
        ...
        abstract EntityAction: EntityAction
        ...
        abstract MergeStrategy: MergeStrategy
        ...
        abstract remoteAccess_odata: string
        abstract remoteAccess_webApi: string
    ...
    type [<AllowNullLiteral>] IProperty =
        ...
        abstract parentType: IStructuralType with get, set
    ...
    type [<AllowNullLiteral>] ComplexTypeStatic =
        [<Emit "new $0($1...)">] abstract Create: unit -> ComplexType
    ...
    type [<AllowNullLiteral>] DataTypeSymbol =
        inherit Breeze.Core.EnumSymbol
        abstract defaultValue: obj option with get, set
    ...
    type [<AllowNullLiteral>] EntityManager =
        ...
        abstract fetchMetadata: ?callback: (obj option -> unit) * ?errorCallback: Breeze.Core.ErrorCallback -> Promise<obj option>
    ...
    type [<AllowNullLiteral>] MetadataStore =
        ...
        abstract addEntityType: structuralType: IStructuralType -> unit
        abstract exportMetadata: unit -> string
        abstract fetchMetadata: dataService: string * ?callback: (obj option -> unit) * ?errorCallback: Breeze.Core.ErrorCallback -> Promise<obj option>
        abstract fetchMetadata: dataService: DataService * ?callback: (obj option -> unit) * ?errorCallback: Breeze.Core.ErrorCallback -> Promise<obj option>
        abstract getDataService: serviceName: string -> DataService
        abstract getEntityType: entityTypeName: string * ?okIfNotFound: bool -> IStructuralType
        abstract getEntityTypes: unit -> ResizeArray<IStructuralType>
    ...
    type [<AllowNullLiteral>] PredicateStaticValue =
        ...
        abstract dataType: Breeze.DataType option with get, set
    ...
    type [<AllowNullLiteral>] ValidatorStatic =
        ...
        abstract registerFactory: fn: (unit -> Validator) * name: string -> unit
    ...
    module Config =
        ...
        type [<AllowNullLiteral>] IExports =
            ...
            abstract setQ: q: Breeze.Promises.IPromiseService -> unit
